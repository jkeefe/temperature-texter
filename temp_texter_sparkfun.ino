...
// http://johnkeefe.net/
// August 2015
// This version: Text to sparkfun via node server
...
String phone_number = "XXXYYYZZZZ"; // put text-receiving number here, "40404" for twitter
String base_message;
...
void loop()
{
  ...
  // device_id,temp,hummidity,battery
  // ie: "John's_Arduino, 78.2, 51.2,90"
  // (Temp & Humidity get padded by a space)
  base_message = base_message + tempTemp + "," + humidityTemp + "," + battery_percent;
